...
VOID ThreadBegin(UINT32 thread_id, VOID* sp, int flags, VOID* v) 
{
...
VOID ThreadEnd(UINT32 thread_id, INT32 code, VOID* v) 
{
...
VOID BeginTransaction(UINT32 thread_id, CHECKPOINT* _chkpt) 
{
    PIN_LockClient();
...
VOID CommitTransaction(UINT32 thread_id)
{
    PIN_LockClient();
...
VOID AbortTransaction(UINT32 thread_id) 
{
...
VOID LogInsTrace(UINT32 thread_id, ADDRINT ip, ADDRINT sp, const string* disassm) 
{
