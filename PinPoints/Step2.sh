...
simpoint -loadFVFile ./t.bb -maxK $MAXK -coveragePct $CUTOFF -saveSimpoints ./t.simpoints -saveSimpointWeights ./t.weights -saveLabels t.labels > simpoint.out
